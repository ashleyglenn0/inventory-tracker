...
//    }
    ...
    public static ArrayList<Item> findByValue(String value, Iterable<Item> allItems) {
        ...
        for (Item item : allItems) {
            ...
            } else if (manufacturer.getName().toString().toLowerCase().contains(value.toLowerCase())) {
                results.add(item);
            } else if (item.getDescription().toLowerCase().contains(value.toLowerCase())) {
                results.add(item);
            } else if (item.getCategory().toLowerCase().contains(value.toLowerCase())) {
                results.add(item);
            }
