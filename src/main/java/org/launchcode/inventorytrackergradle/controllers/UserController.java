...
public class UserController {
    ...
    String populateDatabase(){
        User user = new User("NewUser1", "mail@email.com", "1234567","1234");
        userRepository.save(user);
        User user2 = new User("NewUser2", "mail2@email.com", "89101112","5678");
        userRepository.save(user2);
        User user3 = new User("NewUser3", "mail3@email.com", "13141516","9101");
